    ...
    if (!function_exists('wbc_after_theme_options')) {
        ...
        function wbc_after_theme_options($demo_active_import, $demo_data_directory_path) {
            ...
            if ($demo_type == 'Adforest') {
                ...
                $home = get_page_by_title('Petforest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('MatchForest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('RealEstate Forest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('MobileForest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('ServiceForest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('ToyForest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('DecorForest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('Sports Forest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
            ...
            } else if ($demo_type == 'bookforest') {
                $home = get_page_by_title('BoookForest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('TechForest');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
                ...
                $home = get_page_by_title('LandingPage');
                update_option('page_on_front', $home->ID);
                update_option('show_on_front', 'page');
