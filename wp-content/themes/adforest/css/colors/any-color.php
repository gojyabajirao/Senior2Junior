...
.shop-overlay-box .shop-icon, .ad-sidebar-form .ad-6-message::before,  .featured-slider .owl-controls .owl-nav .owl-next:hover, .featured-slider .owl-controls .owl-nav .owl-prev:hover .ms-layer.btn3:hover, .home-category-slider .category-slider .owl-controls .owl-nav .owl-next:hover, .home-category-slider .category-slider .owl-controls .owl-nav .owl-prev:hover, .subscribe button:hover , .featured-slider-1 .owl-controls .owl-nav .owl-next:hover, .featured-slider-1 .owl-controls .owl-nav .owl-prev:hover , .sticky-post-button:hover , .btn-light:hover , .featured-slider-3 .owl-controls .owl-nav .owl-next:hover, .featured-slider-3 .owl-controls .owl-nav .owl-prev:hover , .hero-form-sub li a:hover , #google-map-btn a:hover , .modern-version-block-cat:hover , .featured-slider-5 .owl-controls .owl-nav .owl-next:hover, .featured-slider-5 .owl-controls .owl-nav .owl-prev:hover {
 ...
 .btn-theme:hover, .btn-theme:focus, .btn-theme:active, .btn-theme.active, .open .dropdown-toggle.btn-theme , .btn-orange:hover, .header-social-h2 .list-inline li .btn-primary:hover, .header-social-h2 .list-inline li .btn-primary:hover{
     color: #ffffff;
     background-color: #dc7b30;
     border-color: #f6944a;
}
 ...
 .mat-hero-text-section h1 span, .tech-mac-book h1 span, .tech-latest-primary-section h3 .explore-style, .tech-view-section h2 span, .land-classified-heading h3 span, .land-classified-text-section .list-inline li i, .land-qs-heading-section h3 span, .land-one-rating i{
...
.listing-detail .listing-content span.listing-price, .dec-featured-details-section p i,.prop-estate-text-section p i {color: #f58936 !important;}
...
.sb-dec-top-bar{background:linear-gradient(90deg, #ffffff 26%, #f58936 0%)}
.sb-header-top4 .sb-dec-top-ad-post a i,.adforest-user-ads b{color: #f58936 !important;}
.sprt-header-box i,.ad-sidebar-style{background: #f58936 !important;}
...
.rtl .sb-dec-top-bar {background: linear-gradient(90deg, #f58936 77%, #fff 67%);}
...
.top-bk-details p span, .des-hero-adres p i,.des-us-details ul li,.des-price ul li span {color: #65c422;}
.new-featured-list-2 .btn-primary{background-color: #65c422;}
.select-buttons .btn-primary {background-color:#65c422;border-color:#f58936; }
.new-featured-list-2 .btn-primary:hover{background-color: #f58936;}
...
.ad-price-tble .ad-pric-content .ad-pic-style{background: linear-gradient(to right, #ffc500, #f58936);}
