    ...
    <img src="<?php echo esc_url($adforest_theme['sb_android_app_img']['url']); ?>" alt="<?php echo esc_attr($adforest_theme['sb_android_app_text']); ?>">
                 <h6><?php echo adforest_returnEcho($adforest_theme['sb_android_app_text']); ?></h6>
  </a>
  <?php
	}
